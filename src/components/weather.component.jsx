        ...
        <div className="card bg-transparent border-0 p-2">
          <div className="card-title">
            <h3>
              ...
              <img
                className="sunrise"
                src="https://cdn2.iconfinder.com/data/icons/weather-flat-icons-2/320/3-64.png"
                alt="rise"
              ></img>
            </h3>
          </div>
        ...
        <div className="card bg-transparent border-0 p-2">
          <div className="card-title">
            <h3>
              ...
              <img
                className="sunset"
                src="https://cdn2.iconfinder.com/data/icons/weather-flat-icons-2/320/2-64.png"
                alt="set"
              ></img>
            </h3>
          </div>
        ...
        <div className="card bg-transparent border-0 p-2">
          <div className="card-title">
            <h3>
              ...
              <img
                className="time"
                src="https://cdn0.iconfinder.com/data/icons/corona-virus-6/48/15-32.png"
                alt="time"
              ></img>
            </h3>
          </div>
